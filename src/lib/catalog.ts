export type Category = "street" | "hats" | "vault";
...
export const CATEGORIES: { id: Category | "all"; label: string; blurb: string }[] = [
  { id: "all", label: "The floor", blurb: "The house — street, gorras, and the vault. Dios sobre todo." },
  { id: "street", label: "Street", blurb: "BAPE, Palm Angels, Coach. What you wear when you pull up." },
  { id: "hats", label: "Gorras", blurb: "Only what’s been scanned and confirmed in the backroom. No ghosts on the floor." },
  { id: "vault", label: "Vault", blurb: "Star Wars vinyls in box, Chase Funkos, the Pokémon book, graded slabs." },
];
...
export const PRODUCTS: Product[] = [
  {
    ...
    details: ["Full zip shark hood", "1st Camo, yellow / green", "Double-checked hardware and print"],
  },
  {
    ...
    details: ["Nylon track cloth", "Gothic sleeve graphic", "Snap + zip front"],
  },
  {
    ...
    details: ["Full-grain pebble leather", "Unlined cognac interior", "Drop-in Montrose or ship insured"],
  },
  {
    ...
    details: ["Relaxed cargo cut", "Camo match to the shark zip", "Adjustable hem"],
  },
  {
    ...
    details: ["Heavyweight jersey", "Oversized fit", "Deadstock, tags on"],
  },
  {
    ...
    details: ["Leather sleeve panels", "Full zip", "Warm-weather cream"],
  },
  {
    ...
    details: ["Heavyweight fleece", "Tonal chest", "Unisex cut"],
  },
  {
    ...
    details: ["Heavy cotton", "Tonal embroidery", "Boxy cut"],
  },
  {
    slug: "dandy-el-mago",
    name: "El Mago",
    ...
    badges: ["Full set", "Heritage", "Scanned"],
    featured: true,
    stock: 1,
    ...
    details: ["Heritage El Mago embroidery", "Satin brim + crystals", "Hard case + card included"],
    scan: "IMG_3652.jpg",
  },
  {
    ...
    badges: ["Full set", "Featured", "Scanned"],
    featured: true,
    stock: 1,
    ...
    details: ["High-crown structured G5", "3D DANDY + crystals", "Hard case + card included"],
    scan: "IMG_3653.jpg",
  },
  {
    slug: "dandy-el-jefe",
    ...
    details: ["Gothic EL JEFE embroidery", "Roses + crystals", "Hard case included"],
    scan: "IMG_4795.jpg",
  },
  {
    slug: "dandy-the-don",
    ...
    details: ["Gothic THE DON embroidery", "Roses + gold dollars", "Hard case included"],
    scan: "IMG_4794.jpg",
  },
  {
    slug: "dandy-the-boss",
    ...
    details: ["Gothic THE BOSS embroidery", "Roses + crystals", "Hard case included"],
  },
  {
    ...
    details: ["Gold gothic PANDILLERO", "Roses + crystals", "Hard case included"],
    scan: "IMG_3821.jpg",
  },
  {
    ...
    details: ["Gothic LA GANGSTERA", "Roses + crystals", "Hard case included"],
    scan: "IMG_4791.jpg",
  },
  {
    ...
    details: ["Burgundy structured crown", "Gold gothic + roses", "Hard case included"],
    scan: "IMG_4752.jpg",
  },
  {
    slug: "dandy-wordmark",
    ...
    details: ["3D DANDY wordmark", "Crystal scatter", "Hard case included"],
    scan: "IMG_4793.jpg",
  },
  {
    slug: "son-of-god-32",
    ...
    details: ["Gothic SON OF GOD + 32", "Chrome cross charms", "Structured black crown"],
    scan: "CE3FB6D8.jpg",
  },
  {
    slug: "dandy-otb",
    ...
    details: ["Gothic Only The Best", "3D tonal front", "Crystals"],
    scan: "95B50775.jpg",
  },
  {
    ...
    details: ["Old English DANDY", "White on black", "Structured crown"],
    scan: "95B50775.jpg",
  },
  {
    ...
    details: ["Skeleton + script front", "White flame sides", "Crystal scatter"],
    scan: "95B50775.jpg",
  },
  {
    slug: "love-daisy",
    ...
    details: ["White daisy embroidery", "LOVE lettering", "Crystals"],
    scan: "95B50775.jpg",
  },
  {
    ...
    details: ["Chase metallic paint", "Mint in box", "Open to trade for graded grails"],
  },
  {
    ...
    details: ["Glow-in-the-dark chase", "Mint window box", "Trades considered"],
  },
  {
    ...
    details: ["Metallic gold chase", "Mint in box", "Vault locked — ask to see it"],
  },
  {
    ...
    details: ["Deluxe two-pack", "Target exclusive", "Mint in box"],
  },
  {
    ...
    details: ["Six mint-in-box", "Photographed on the shelf", "Package trades welcome"],
  },
  {
    ...
    details: ["Raw mixed lot", "Holos in the mix", "Photographed in-house"],
  },
  {
    ...
    details: ["1999 Base Set unlimited", "PSA 8 NM-MT", "In-house photographed slab"],
  },
  {
    ...
    details: ["Special illustration rare", "PSA 10 GEM MT", "Trades into vintage considered"],
  },
  {
    ...
    details: ["Enchanted foil", "CGC 10 Pristine", "Vaulted until pickup"],
  },
  {
    ...
    details: ["Legendary foil", "PSA 10 GEM MT", "Open to package trades"],
  }
];
...
export function relatedProducts(product: Product, limit = 4) {
  return PRODUCTS.filter((p) => p.slug !== product.slug && p.category === product.category).slice(
    0,
    limit,
  );
}

export const BRANDS = [...new Set(PRODUCTS.map((p) => p.brand.split(" · ")[0]))];
